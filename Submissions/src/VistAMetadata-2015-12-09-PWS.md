...
__1.6.15.1 Artifact Repository: To facilitate the management, reporting, collaboration, and continuity of access of all government artifacts and deliverables produced under this contract as a single logical unit, all artifacts and deliverables shall be developed, version-controlled, stored, and delivered on an industry-standard public Github repository (“Project Repository”) with clearly designated and appropriate licenses.__  Upon commencement of the contract period, the contractor shall establish the Project Repository, and provide the publically accessible URL of the Project Repository to the project manager, contracting representative, and relevant government stakeholders.  (Deliverable #1)

The Project Repository shall contain the one and only authoritative source of all artifacts produced under this contract. Developers shall have full push-pull privileges and do continuous collaborative development in real-time on single authoritative source. The government, all necessary stakeholders, and the public shall also have contemporaneous read and download access of the same developer artifacts at all times throughout the lifecycle of the contract. This team access to the same artifacts support real-time collaborative development, testing, project management, progress reporting, review,  and oversight of all artifacts in one location. 

All artifacts of the Project Repository shall be hosted on the public Github repository by default. Should a subset of content in the Project Repository contain proprietary, protected, or sensitive information or content, then contractor shall use a private repository *for only this subset of content*, and shall document and maintain an always-up-to-date index of said redacted artifacts on the main, with reasons for redaction, on the main public Project Repository. A private repository may be created and managed as restricted, private Github repository (a) within the primary public Github Repostory, or (b) within a repository managed behind a government firewall on Github Enterprise.  In all cases, government and required stakeholders shall have full access to  (a) all repositories, private and public, at all times and (b) an index of all content, private and public, that correctly lists all content.  

For purposes of this contract, independent of whether segments of the Project Repository are  hosted on public or private repositories, the Project Repository and its entirety of content shall be considred Government Furnished Equipment (GFE) to eliminate any ambiguity surrounding ownership of said content.
