# VISTA Data Project:  Technical Overview
...
:--- | :--- | :---
![](/images/logos/logos-presentations/60h/linkedVISTA.jpg) <br> [Rafael&nbsp;Richards](https://www.linkedin.com/in/rafaelrichardsmd)  | [__Linked VISTA__ (PDF)](https://github.com/vistadataproject/documents/blob/master/Background/presentations/Linked_VISTA-Rafael%20Richards-2015.pdf) | This describes the design and features of an enterprise cross-linked Master VISTA Data Model (MVDM) to provide master data management across all VA VISTA systems. (2015)
