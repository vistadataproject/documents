...
__Noninvasive__ | __Provides VISTA essential new functionality on top of the unmodified VISTA architecture 'as is'.__ <br> *No existing VISTA code, routines, packages, modules, or infrastructure will be affected or changed in any way (i.e. this is 'safe' and 'noninvasive').*
