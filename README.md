...
This transition of VISTA's interface from insecure RPC wrappers to a Model-driven __Secure Access Framework for the Enterprise (SAFE)__ is summarized in the figure below.
