...
The VISTA Data Project is about comprehensively exposing all of VA's 35 years of patient data and institutional know-how contained in  130 VA VISTA systems in a single machine-processible form, and then making all this data accessible and computable using a one consistent mechanism:  a single, embedded, server-side, security-enabled, symmetric read-write Master VISTA Data Model.
