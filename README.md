...
* By virtue of VA's formal technical review and approval of the Resource Description Framework (RDF) in the OneVA Technical Reference Model (TRM), VA formally endorses use of RDF (web-standard data model) for use in the VA enterprise architecture. See [TRM-RDF](http://www.va.gov/TRM/StandardPage.asp?tid=6405).
* By virtue of VA's review and approval of Node.js in the OneVA Technical Reference Model (TRM), VA formally endorses the Node.js (Javascript/MUMPS binding) technology for use in the  VA enterprise architecture. See [TRM-NodeJS](http://www.va.gov/TRM/ToolPage.asp?tid=6716).
