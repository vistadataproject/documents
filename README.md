...
__Note: As a side-effect of VA taking a data-centric, model-driven approach to VISTA's data, a very high percentage of VISTA's legacy code - which served no other purpose than to access small fragments of VISTA data - can be retired.__
