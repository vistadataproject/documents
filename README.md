...
__Web-Scale__  | The VISTA Data Model uses the same web-scale Linked Data model and technology used by Google, Yahoo, Microsoft, and other major search engines to crawl, link, and index all structured data on the web. Leveraging this common Linked Data Space allows VISTA to become a first-class citizen of the Internet of Data, and dynamically link to thousands of Linked Data resources on the web. Semantic, dynamic linking of infrormation from VISTA would allow virtually unlimited enrichment of the health record of any patient specific for their conditions with always-up-to-date information.
