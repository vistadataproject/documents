...
The figure below summarizes the evolution from client-specific code-driven interfacing (over 3500 MUMPS routines) to that of a single client- and language-agnostic model-driven interface:
