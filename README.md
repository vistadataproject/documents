...
* By virtue of VA's technical review and approval of the Resource Description Framework (RDF) in the OneVA Technical Reference Model, VA formally endorses the RDF web-standards-based data model in the VA enterprise architecture. JSON-LD is one of many serializations of RDF. See [TRM-RDF](http://www.va.gov/TRM/StandardPage.asp?tid=6405) and [JSON-LD](http://json-ld.org).
* By virtue of VA's review and approval of Node.js in the OneVA Technical Reference Model, VA endorses the Node.js (Javascript/M binding) technology in the  VA enterprise architecture. See [TRM-NodeJS](http://www.va.gov/TRM/ToolPage.asp?tid=6716) and [Cache/Node](http://docs.intersystems.com/ens20141/csp/docbook/DocBook.UI.Page.cls?KEY=BXJS_intro)
