...
__Data Integrity__ | Provides VISTA with its first single, comprehensive framework for strict error checks for all information provided to or from all clients. *This is a major improvement over the hodge-podge of methods (HL7, RPCs, procedural code), which are all inconsistent, unpredictable, and highly permissive*
