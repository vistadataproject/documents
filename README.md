...
*Note: As a side-effect of establishing a single, comprehensive model-driven access method to all of VA's VISTA data, a large portion of VISTA's legacy code (its thousands of redundant and idiosyncratic data extraction methods) may be retired.*
