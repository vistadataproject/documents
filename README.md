...
The figure below summarizes the evolution from thousands of legacy MUMPS client-specific code-driven interfaces to that of a single, standard, secure Javascript/Node.js  model-driven interface:
