...
* By virtue of VA including Node.js as an formally approved component of the [OneVA Technical Reference Model](http://www.va.gov/TRM/ToolPage.asp?tid=6716), VA again endorses Node.js approach as key to its enterprise architecture.
* By virtue of inclusion of the Node/Cache binding in all official commercial releases, Intersystems views in-process node.js coding of Javascript on MUMPS as practical, maintainable, and critical for their commercial customers.
