...
__Data-driven__ | __MVDM is a new, purely data-centric approach to managing VISTA's data__.  It does not involve hacking a single line of the 2.2 million lines legacy MUMPS code. *It is the opposite of a code-centric approach*.
