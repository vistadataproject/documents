...
__Data Security__ | Provides VISTA with its first comprehensive, granular, on-the-data, *Data-Level, Logical Security Model*. Currently VISTA is data-category agnostic. Through metadata enrichment of the VISTA Data Model, VISTA will know for the first time *what categories of data it is managing* (patient data, institution data, etc.). This Data-Centric, Logical Security Layer is the foundation for all other security measures, since without knowlege of what the data is and its category, one won't know the appropriate security measures to apply to it.  See [Data-Centric Security](https://en.wikipedia.org/wiki/Data-centric_security) and [Logical Data Boundaries](http://www.mdpi.com/1999-5903/4/4/929/htm#fig_body_display_futureinternet-04-00929-f001)
