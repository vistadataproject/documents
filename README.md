...
--- | --- | ---
Method |  :exclamation:  Relies on over 3500 legacy MUMPS routines that are undocumented, inconsistent, and apply different routines for reading than writing the same data|  :new: Data Model-Driven <br>  :new: :+1: One single, symmetric read-write mechanism for all data. <br>:+1: No code involved. 
