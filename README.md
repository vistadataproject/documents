...
![db-linkage](https://github.com/vistadataproject/documents/blob/master/images/logos/logos-db/50h/db-linkage.jpg) <br> __Linkage__ | __Direct semantic linkage and augmentation of external structured data to *VISTA data*.__  The largest world wide web search companies (Google, Yahoo, Microsoft, and others) and knowledge orgainizations (including the National Library of Congress and National Library of Medicine) all use the Linked Data standard as the medium for publication, indexing, linking, and semantic search of the vast amount of structured data in their oranization and on the web. Because MVDM also uses the Linked Data model and technology, VISTA will also acquire the same capability to semantically link its data to all these data sources and to the vast amount of structured data on the web. Linking a patient's health information in VISTA to authoritative health data sources or to the [Linked Open Data cloud](http://lod-cloud.net), for example,  will create a highly contextualized patient-specific enrichment of their health record. This will provide imporved clinical decisionmaking and support  [Clinical Services Research](https://www.ncbi.nlm.nih.gov/books/NBK253312). See also: [Record Linkage](https://en.wikipedia.org/wiki/Record_linkage)
