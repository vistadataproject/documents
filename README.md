...
![VDP-annotated](/images/vdp-basic-annotated10.png)
...
__Server-side__ | All data, transformations, and models are processed in-process, server-side. This eliminates moving parts and maximizes transaction processing performance by running directly on the local database - with no middleware - leveraging the 'as-is' database architecture.
