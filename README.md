...
--- | --- | ---
Method |  MUMPS RPC code <br> Relies on over 3500 legacy MUMPS routines|  :new: Data Model-Driven <br>  :new: :+1: One single, symmetric read-write mechanism for all data. <br>:+1: No code involved. 
