...
__Web-Scale__  | The VISTA Data Model uses the same universal web-scale Linked Data model and technology used by Google, Yahoo, Microsoft, and other major search engines to crawl, link, and index all structured data on the web. Leveraging this common web-scale Linked Data Space would allow VISTA to dynamically link to thousands of Linked Data resources on the web. This semantic, dynamic linking of specific infrormation from VISTA allows virtually unlimited enrichment of the health record of any patient specific for their conditions with always-up-to-date information.
