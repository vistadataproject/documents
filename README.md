...
__Web-Scale__  | __MVDM enables VISTA to natively and dynamically link to thousands of external Linked Data resources on the web, because it shares the same web-standard, web-scale Linked Data model as the worlds largest search engines.__ Linked Data is used by the largest web search engines and knowledge organizations to index, search and link to the structured data on the web. By sharing the same Linked Data model and technology, VISTA becomes a first-class citizen of the Web of Linked Data.  Linking specific patient information from VISTA, for example, would allow highly personalized enrichment of the veteran information with always-up-to-date authoritative sources of information.
