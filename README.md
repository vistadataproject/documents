...
__Reliability and Safety__ | Provides VISTA with its first comprehensive, strict error checks for information provided to or from clients.<br> *Not a hodge-podge of inconsistent methods (HL7, RPCs, and procedureal code) which are all permissive*
