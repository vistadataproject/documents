...
* By virtue of VA's review and approval of Node.js in the OneVA Technical Reference Model, VA formally endorses the Node.js (Javascript/MUMPS) technology for use in the  VA enterprise architecture. See [TRM-NodeJS](http://www.va.gov/TRM/ToolPage.asp?tid=6716) and [Cache/Node](http://docs.intersystems.com/ens20141/csp/docbook/DocBook.UI.Page.cls?KEY=BXJS_intro)
