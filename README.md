...
* By virtue of VA's review and approval of Node.js in the OneVA Technical Reference Model, VA formally endorses the Node.js (Javascript/MUMPS binding) technology for use in the  VA enterprise architecture. See [TRM-NodeJS](http://www.va.gov/TRM/ToolPage.asp?tid=6716).
