...
__Note: As a side-effect of VA taking a data-centric, model-driven approach to VISTA's data, a very high percentage of VISTA's legacy code can be retired.__
