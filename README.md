...
### Metadata-driven Symmetric Read-Write Master Data Model for VA VISTA
...
All sources of available metadata (both intrinsic to VISTA as well as extrinsic, such as RPCs) will be transformed, enriched, and then operationalized in an embedded, in-process web-standard data model within Node.js / VISTA  (nodeVISTA). Strictly web data standards and technologies will be used:
