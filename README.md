...
*Note: As a side-effect of establishing standardized, model-driven access to all of VA's VISTA data, much of VISTA's procedural code may be retired.*
