...
__Data-driven__ | __MVDM is a new, purely data-centric, data-driven approach to managing VISTA's data__.  It does not involve changing a single line of the 2.2 million lines of VISTA's existing M procedural code, nor is it 'wrapping' this legacy code in any form of container. *This is the opposite of a code-centric approach*.
