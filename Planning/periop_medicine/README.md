...
This is a collaboration of the VISTA Data Program with VA Anesthesiology and Critical Care data analysts to create real-time web-based operational reports against live, production VISTA systems leveraging the VISTA Data Project infrastructure.  
